                            ...
                            <tr class="<?php echo ($index % 2 == 0) ? 'even-row' : 'odd-row'; ?>">
                                ...
                                <td>
                                    <a onclick="" class="remover-restaurante" href="pageReceitaIngreMedida.php?idIngrediente=<?php echo $ingrediente['idIngrediente'];?>&acao=delete">
                                        Remover </a>
                                    <a onclick="editarIngrediente(<?php echo $ingrediente['idIngrediente'] ?>, '<?php echo $ingrediente['nome'] ?>', '<?php echo $ingrediente['descricao']; ?>')" 
                                    href="#" class="editar-ingrediente" id="btn-salvar-ingrediente" 
                                    data-id="<?php echo $ingrediente['idIngrediente']; ?>"> Editar </a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                            ...
                            <tr class="<?php echo ($index % 2 == 0) ? 'even-row' : 'odd-row'; ?>">
                                ...
                                <td>
                                    <a onclick="" class="remover-medida" href="pageReceitaIngreMedida.php?idMedida=<?php echo $medida['idMedida'];  ?>&acao=deleteM">
                                        Remover </a>
                                    <a onclick="editarMedida(<?php echo $medida['idMedida'] ?>, '<?php echo $medida['descricao']; ?>')" 
                                    href="#" class="editar-medida" id="btn-salvar-medida" 
                                    data-id="<?php echo $media['idMedida']; ?>"> Editar </a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
