function excluirComposicao(link, nome_receita, idIngrediente, idMedida) {
    // if (confirm("Tem certeza que deseja excluir esta composição?")) {
        $.ajax({
            type: 'GET',
            url: '../../../controller/receitaComposicaoController.php',
            data: {
            ...
            success: function(data) {
                ...
                // Atualize a tabela ou faça outras manipulações no DOM, se necessário
                // Exemplo de ocultar a linha na tabela:
...
function atualizarComposicao() {
    ...
    xhr.open('POST', '../../../controller/receitaComposicaoController.php', true);
